...
class YouveGotMessages {
  ...
  String plurals(number) => Intl.message(
      """${Intl.plural(number, zero: 'Is zero plural?', one: 'This is singular.', other: 'This is plural ($number).')}""",
      name: 'plurals',
      args: [number],
      desc: 'Basic plurals');

  String whereTheyWent(Person person, String place) =>
