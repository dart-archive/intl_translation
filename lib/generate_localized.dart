...
class MessageGeneration {
  ...
  /// Generate a string that containts the dart code with the [translations] in
  /// [locale].
...
${releaseMode ? overrideLookup() : ''}''';
  ...
  String$orNull lookupMessage(
    ...
    String failedLookup(String$orNull message, List<Object>$orNull args) {
      throw UnsupportedError("No translation found for message '\$name' "
          "(original text: '\$message')");
    }

    return super.lookupMessage(message, locale, name, args, meaning,
...
''';
  ...
  String generateLocalesImportFile() {
    ...
    var sortedLocales = allLocales.toList()..sort();
...
class TranslatedMessage {
  ...
  /// The original messages that we are a translation of. There can be more than
  /// one original message for the same translation.
